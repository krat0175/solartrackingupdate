pipeline {
    ...
    parameters {
            string(name: 'opcos', defaultValue: '001,002,003,004,005,008,009,011,013,014,015,016,017,018,019,022,023,025,027,031,035,036,037,043,045,047,049,050,052,055,059,060,061,075,078,101,102,134,137,146,147,148,163,164,293,306,320,335,344,429,450,est,cst,mst,pst', description: 'opco list')
        }
    stages {
        stage('Checkout'){
            steps{
